	...
	function get_suggestions_list( $args ) {
		...
		<div class="youzify-items-list-widget youzify-suggested-friends-widget youzify-list-avatar-circle">
			...
			<div class="youzify-list-item">
				<a href="<?php echo esc_url( $profile_url ); ?>" class="youzify-item-avatar"><?php echo bp_core_fetch_avatar( array( 'item_id' => $friend_id, 'type' => 'thumb' ) ); ?></a>
				<div class="youzify-item-data">
					<a href="<?php echo esc_url( $profile_url ); ?>" class="youzify-item-name"><?php echo bp_core_get_user_displayname( $friend_id ); ?><?php youzify_the_user_verification_icon( $friend_id ); ?></a>
				...
				<div class="youzify-item-action">
					<a href="<?php echo esc_url( wp_nonce_url( bp_loggedin_user_domain() . bp_get_friends_slug() . '/add-friend/' . $friend_id . '/', 'friends_add_friend' ) ); ?>" class="youzify-list-button youzify-icon-button youzify-add-button"><i class="fas fa-user-plus"></i></a>
					<a href="<?php echo esc_url( bp_get_root_url() . "/refuse-friend-suggestion/?suggestion_id=" . $friend_id . "&_wpnonce=" . wp_create_nonce( 'friend-suggestion-refused-' . $friend_id ) );?>" class="youzify-list-button youzify-icon-button youzify-close-button"><i class="fas fa-trash-alt"></i></a>
				</div>
				<?php endif; ?>
			</div>
			<?php endforeach; ?>
