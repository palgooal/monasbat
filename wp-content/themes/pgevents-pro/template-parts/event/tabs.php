    ...
    function activate(tab) {
        ...
        btns.forEach(function(b) {
            ...
            if (active) {
                ...
                b.className = 'event-tab-btn flex h-11 shrink-0 items-center rounded-xl border border-border bg-white px-5 text-sm font-semibold text-foreground/80 ' + (b.disabled ? 'opacity-40 cursor-not-allowed' : 'hover:bg-secondary/40');
